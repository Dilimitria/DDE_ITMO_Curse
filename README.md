...
Поиск выбросов с помощью метода межквартильного размаха (IQR) и графиков boxplot.
...
##Скорость анализа: Чтение готовой витрины происходит в 10 раз быстрее, чем обработка сырого CSV.

##Гибкость: Возможность проводить сегментацию по любому срезу данных (время, страна, товар).

##Масштабируемость: Пайплайн на Prefect позволяет легко добавлять новые этапы обработки.
